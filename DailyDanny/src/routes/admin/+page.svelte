...
<div class="profile">
  <a class = "prof-buttons"  on:click={toggleCreateUserPopup}>Create admin/editor account</a><br/>
  <a class = "prof-buttons" href="/profile/viewArticles/all">View all articles</a><br/>
  <a class = "prof-buttons" href="/profile/viewArticles/pending">View pending articles</a><br/>
...
<style>
  ...
  .prof-buttons:hover{
        background-color:rgb(88, 102, 102);
        color: white;
  }
